    ...
    <>
      ...
      <Main>
        <Box>
          ...
          {isLoading && <Loader />}
          {!isLoading && !error && (
            <MoviesList movies={movies} onSelected={handleSeletedMovie} />
          )}
  ...
  return (
    <div className="details">
      {isLoading ? (
        ...
        <>
          <header>
            <button className="btn-back" onClick={() => handleClosed()}>
              &larr;
            </button>
            <img src={poster} alt={`iPoster of ${movie} movie`} />
...
function WatchedMovieList({ watched, onDeletewatched }) {
  watched.map((movie) => console.log(movie));
  return (
    <ul className="list">
      {watched.map((movie) => (
